...
function fetch_data(){
    ...
    $query="select * from tblposts group by PostingDate";
    $result=mysqli_query($connect,$query);
    while($row=mysqli_fetch_array($result)){
        $output.='
        <tr>
            <td> '. $row["PostTitle"] .' </td>
            <td> '. $row["PostDetails"] .' </td>
...
if(isset($_POST["create_pdf"]))  
 {  
      ...
      $content = '';  
      $content .= '  
      <h3 align="center">News Details</h3><br /><br />  
...
<br>
<form method=post>
    <input type="submit" name="create_pdf" class="btn btn-danger" value="Create PDF"/><br>
</form>
</br>
<?php
