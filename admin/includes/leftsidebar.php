                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="manage-users.php" class="waves-effect"><i class="mdi mdi-account-multiple"></i> <span> Manage Users </span> </a>
                         
                            </li>
                            <li class="has_sub">
                                <a href="manage-faculty.php" class="waves-effect"><i class="mdi mdi-account-multiple"></i> <span> Manage Faculty </span> </a>
  ...
  <li class="has_sub">
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-animation"></i> <span> Pages </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
   ...
   <li class="has_sub">
    ...
    <li class="has_sub">
                                <a href="feedback.php" class="waves-effect"><i class="mdi mdi-message-draw"></i> <span> User Feedbacks </span> </a>
