...
include('includes/configfeedback.php');
error_reporting(0);
...
function fetch_data(){
    ...
    $query="select * from poll order by id asc";
...
if(isset($_POST["create_pdf"]))  
 {  
      ...
      $content = '';  
      $content .= '  
      <h3 align="center">Feedback List From Users</h3><br /><br />  
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Newsportal | Feedback Page</title>
